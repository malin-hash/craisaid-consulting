...
export default function About(){
  return (
    <div className="container py-20 w-full bg-slate-200 md:px-64 p-10">
      <h2 className="text-xl font-semibold mb-4 text-center text-green-500">Qui nous sommes ? </h2>
      <div className='grid grid-cols-1 gap-4 px-8'>
        <div>
          <h1 className='text-lg font-semibold text-black text-justify'>Notre Objectif</h1>
        ...
        <div>
          <h1 className='text-lg font-semibold text-black text-justify'>Notre vision</h1>
